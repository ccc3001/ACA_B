...
/* =========================================
   Polynomial kernel (medium-hard)
   K(x,y) = (1 + x^T y)^8
   ========================================= */

double
test_function_poly8(int d,
                    const double *x,
                    const double *y)
{
  double dot = 0.0;
...
/* =========================================
   Multiquadric kernel
   K(x,y) = sqrt(1 + 100 r^2)
   ========================================= */

double
test_function_mq(int d,
                 const double *x,
                 const double *y)
{
  double r2 = 0.0;
  ...
  return sqrt(1.0 + 100.0 * r2);
}

/* =========================================
   Inverse multiquadric kernel
   K(x,y) = 1/sqrt(1 + 100 r^2)
   ========================================= */

double
test_function_imq(int d,
                  const double *x,
                  const double *y)
{
  double r2 = 0.0;
